function renderMatchProfile (req: any, res: any) {
    const profileData = {
        ...
        ownGender: 'Male',
        age: 31,
        profileImages: [ '/visitorProfileImages/available-traveler.jpg', '/visitorProfileImages/available-traveler.jpg', '/visitorProfileImages/available-traveler.jpg', '/visitorProfileImages/available-traveler.jpg' ],
